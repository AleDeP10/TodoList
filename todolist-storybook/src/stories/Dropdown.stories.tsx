...
export const MobileView: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: `
⚠️ Known issue: The story does not render correctly in the Docs preview: the Label remains positioned to the left of the Dropdown, instead of stacking vertically.
